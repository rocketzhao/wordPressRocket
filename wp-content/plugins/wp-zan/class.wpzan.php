...
class wpzan {
	...
	public function zan_button($odc){
		...
		$btn_html = $odc ? '<a id="wp-zan-%d" name="wp-zan" class="%s" onclick="%s" href="javascript:;"><span>%d</span></a>' : '<a id="wp-zan-%d" name="wp-zan" class="%s" onclick="%s" href="javascript:;"><i class="icon-wpzan"></i>赞 (<span>%d</span>)</a>';
